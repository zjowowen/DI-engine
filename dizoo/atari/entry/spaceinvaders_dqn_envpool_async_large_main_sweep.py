...
def sweep_main():
    ...
    if not good_pair:
        ...
        spaceinvaders_dqn_envpool_config.exp_name = f'spaceinvaders_dqn_envpool_async_large-{wandb.config.collector_env_num}-{wandb.config.collector_batch_size}'
...
if __name__ == "__main__":
    ...
    sweep_id = wandb.sweep(
        ...
        project='SpaceInvaders-v5-envpool-sweep'
        )
