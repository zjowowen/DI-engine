...
def sweep_main():
    ...
    if not good_pair:
        ...
        pong_dqn_envpool_config.exp_name = f'pong_dqn_envpool_async_large-{wandb.config.collector_env_num}-{wandb.config.collector_batch_size}'
